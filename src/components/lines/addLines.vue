    ...
    <form @submit.prevent="submitForm" >
         <q-card-section class="q-pt-none">
           <div class="column full-width">
             <div>
                  <q-input outlined v-model="lineToSubmit.name" label="Name" :rules="[val => !!val || 'Field is required']" ref="name"/>
             </div>
            <div>    
              <q-input type="textarea" outlined v-model="lineToSubmit.description" label="Description" :rules="[val => !!val || 'Field is required']" ref="description"/>
            </div>
            <div>
              <q-toggle
                label="Active"
                v-model="lineToSubmit.active"
                checked-icon="check"
                color="green"
